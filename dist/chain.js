...
var breakChain = function (breakValue) { return ({ __$break: true, breakValue: breakValue }); };
    ...
    var iterablePromiseFn = function (fn) {
        return new Promise(function (resolve, reject) {
            ...
            if (isChainAccumulator(fn)) {
                ...
                var fnResults = keys_1.map(function (key) { return fn[key](results, breakChain); });
            ...
            if (isChainPromiseFunc(fn)) {
                var result = fn(results, breakChain);
                if (isBreak(result)) {
